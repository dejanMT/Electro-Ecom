            ...
            <div class="row main-footer">
                <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="main-footer-info">
                        <img src="dist/images/logo/whiteLogo.png" alt="Company Logo" width="250" class="img-fluid">
                        <p>Electro provides premium quality products from known brands, for a cheap price!</p>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="copyright d-flex justify-content-between align-items-center">
                        <div class="copyright-text order-2 order-lg-1">
                            <p>&copy; <?php echo date('Y') ?>. <a href="https://www.dejan-mt.com/" target="_blank">dejan_mt</a></p>
                        </div>
